...
{
    public class Nasdaq100Historical : RequesterWithoutRequestBase<HistoricalIndexConstituentsResponse, List<HistoricalIndexConstituent>>, IHistoricalConstituents
    {
