...
{
    public class AvailableTsx : AvailableSecuritiesBase, IAvailableSecurities
    {
        public AvailableTsx(IFmpCloudConfiguration configuration, ISubmitter submitter, ILogger<FmpCloudClient> logger)
